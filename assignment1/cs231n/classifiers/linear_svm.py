...
def svm_loss_naive(W, X, y, reg):
  ...
  loss +=  reg * np.sum(W * W) # * 0.5 ----smth with numerical gradient and how is implem
...
def svm_loss_vectorized(W, X, y, reg):
  ...
  #print("correct_scores reshaped", correct_scores.shape)
  #print(correct_scores)

  scores += - correct_scores + 1 # delta = 1
